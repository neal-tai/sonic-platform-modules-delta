...
static ssize_t set_lpmode(struct device *dev, struct device_attribute *devattr, const char *buf, size_t count) 
{
    ...
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_LP_MODE_1, (u8)(data & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_LP_MODE_2, (u8)((data >> 8) & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_LP_MODE_3, (u8)((data >> 16) & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_LP_MODE_4, (u8)((data >> 24) & 0xff));
...
static ssize_t set_reset(struct device *dev, struct device_attribute *devattr, const char *buf, size_t count) 
{
    ...
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESET_1, (u8)(data & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESET_2, (u8)((data >> 8)& 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESET_3, (u8)((data >> 16) & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESET_4, (u8)((data >> 24) & 0xff));
...
static ssize_t set_response(struct device *dev, struct device_attribute *devattr, const char *buf, size_t count) 
{
    ...
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESPONSE_1, (u8)(data & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESPONSE_2, (u8)((data >> 8)& 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESPONSE_3, (u8)((data >> 16) & 0xff));
    i2c_smbus_write_byte_data(pdata[system_cpld].client, SFP_RESPONSE_4, (u8)((data >> 24) & 0xff));
